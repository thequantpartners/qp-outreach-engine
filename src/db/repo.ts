...
export class OutreachRepo {
  private static defaultServices: ServiceDefinition[] = [
    ...
    },
    {
      ...
      outreachTemplateB: `Buenas tardes al equipo de *{{name}}* 👋\n\nLes escribe el equipo de Kenneth Herrera en The Quant Partners.\n\nUna consulta breve: cuando un cliente o paciente les pide información por WhatsApp y los deja en visto, ¿tienen un sistema para reactivarlo automáticamente o esa venta suele perderse?`,
      followUpTemplate1: `Buenas tardes al equipo de *{{name}}* 👋 Les escribe el equipo de Kenneth Herrera nuevamente. Quería consultarles con total respeto si pudieron revisar la consulta anterior sobre las ventas que quedan en visto en su WhatsApp, o si los agarro en una semana complicada. ¡Un saludo!`,
